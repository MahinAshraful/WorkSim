        ...
        <div className="lg:col-span-1 space-y-6">
          <Card className="p-8 rounded-2xl shadow-lg border border-primary-100 bg-white/95 animate-slide-up">
            <div className="text-center">
              ...
              <h1 className="text-xl font-bold text-primary-900 mb-2 font-sans text-center">{userData.name}</h1>
              <p className="text-primary-700 mb-3 font-medium text-center">{userData.email}</p>
              <p className="text-sm text-primary-400 mb-8 text-center">Member since {userData.joinDate}</p>
              <div className="space-y-4">
                <Button 
                  variant="primary" 
                  className="w-full rounded-xl text-lg font-bold bg-gradient-to-r from-primary-600 to-primary-500 hover:from-primary-700 hover:to-primary-600"
